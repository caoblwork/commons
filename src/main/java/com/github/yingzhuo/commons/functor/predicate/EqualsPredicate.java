...
/**
 * Predicate implementation that returns true if the result of predicates are the same.
 * 
 * @author YING Zhuo
 */
@SuppressWarnings({"unchecked", "rawtypes"})
public final class EqualsPredicate<T> implements Predicate<T>, PredicateDecorator<T>, Serializable {
	...
	public static <T> Predicate<T> getInstance(Predicate<T> predicate1, Predicate<T> predicate2) {
        return new EqualsPredicate(predicate1, predicate2);
    }
     ...
     * @param predicate2  the second predicate to check, not null
     */
    private EqualsPredicate(Predicate<T> predicate1, Predicate<T> predicate2) {
    ...
    /**
     * Evaluates the predicate returning true if either predicate returns are the same.
     * 
