...
/**
 * <p>A {@link CommandContext} represents the state information that is
 * accessed and manipulated by the execution of a {@link Command} or a
 * {@link Chain}.  Specialized implementations of {@link CommandContext} will
 ...
 *
 * <p>Implementations of {@link CommandContext} must also implement all of the
 ...
 * properties added to a particular {@link CommandContext} implementation exhibit
 ...
 * visible by calling <code>getFoo()</code>.  If your {@link CommandContext}
 ...
 * implementations of {@link CommandContext} should generally be created by extending
 * the provided base class ({@link org.DefaultCommandContext.commons.chain.impl.ContextBase})
 * rather than directly implementing this interface.</p>
 *
 * <p>Applications should <strong>NOT</strong> assume that
 * {@link CommandContext} implementations, or the values stored in its
