 ...
 */
package com.github.yingzhuo.commons.exception;
...
public final class ThrowableUtils {
	...
	public static <X1 extends Throwable, X2 extends Throwable> void propagateIfPossible(
			Throwable throwable, Class<X1> declaredType1,
			Class<X2> declaredType2) throws X1, X2 {
		Validate.notNull(declaredType2);
	...
	public static RuntimeException propagate(Throwable throwable) {
		propagateIfPossible(Validate.notNull(throwable));
	 ...
	 * list will be {@code throwable} followed by its cause hierarchy. Note that
