...
public class PredicatedSortedMap<K, V>
     ...
     */
    public static <K, V> SortedMap<K, V> decorate(SortedMap<K, V> map, Predicate<K> keyPredicate, Predicate<V> valuePredicate) {
     ...
     * @throws IllegalArgumentException if the map is null
     */
    protected PredicatedSortedMap(SortedMap<K, V> map, Predicate<K> keyPredicate, Predicate<V> valuePredicate) {
