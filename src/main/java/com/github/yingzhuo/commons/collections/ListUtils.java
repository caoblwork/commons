...
import com.github.yingzhuo.commons.collections.list.ImmutableList;
import com.github.yingzhuo.commons.collections.list.PredicatedList;
import com.github.yingzhuo.commons.collections.list.SynchronizedList;
import com.github.yingzhuo.commons.collections.list.TransformedList;
...
public class ListUtils {
     ...
     */
	public static <E> List intersection(final List<E> list1, final List<E> list2) {
     ...
     * @throws NullPointerException if either list is null
     */
    public static <E> List<E> subtract(final List<E> list1, final List<E> list2) {
     ...
     * @throws NullPointerException if either list is null
     */ 
    public static <E> List sum(final List<E> list1, final List<E> list2) {
     ...
     */
    public static <E> boolean isEqualList(final Collection<E> list1, final Collection<E> list2) {
        if (list1 == list2) {
            return true;
        }
     ...
     */
    public static <E> List<E> retainAll(Collection<E> collection, Collection<E> retain) {
     ...
     * @since Commons Collections 3.2
     */
    public static <E> List<E> removeAll(Collection<E> collection, Collection<E> remove) {
    ...
    public static <E> List<E> immutableList(List<E> list) {
        return ImmutableList.decorate(list);
    }
     ...
     */
    public static <E> List<E> transformedList(List<E> list, Transformer<E> transformer) {
