...
import com.github.yingzhuo.commons.collections.MapConstraints.ConstrainedMap;
import com.github.yingzhuo.commons.lang.primitive.PrimitiveUtils;
...
public final class MutableClassToInstanceMap<B>
  ...
  private static <B, T extends B> T cast(Class<T> type, B value) {
    return PrimitiveUtils.wrap(type).cast(value);
  }
