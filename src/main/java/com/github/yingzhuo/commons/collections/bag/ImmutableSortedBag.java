 ...
 */
public final class ImmutableSortedBag<E>
        extends AbstractSortedBagDecorator<E> implements Immutable, Serializable {
	...
	public static <E> SortedBag<E> decorate(SortedBag<E> bag) {
        ...
        return new ImmutableSortedBag(bag);
    }
     ...
     * @throws IllegalArgumentException if bag is null
     */
    private ImmutableSortedBag(SortedBag<E> bag) {
        super(bag);
    }
