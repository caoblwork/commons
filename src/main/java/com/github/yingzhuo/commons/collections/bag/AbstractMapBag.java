...
public abstract class AbstractMapBag<E> implements Bag<E> {
	...
	boolean containsAll(Bag other) {
        ...
        while (it.hasNext()) {
            ...
            boolean contains = getCount((E) current) >= other.getCount(current);
	...
	boolean retainAll(Bag other) {
        ...
        while (i.hasNext()) {
            ...
            int myCount = getCount((E)current);
	...
	public Object[] toArray() {
        ...
        while (it.hasNext()) {
            Object current = it.next();
            for (int index = getCount((E)current); index > 0; index--) {
                result[i++] = current;
            }
        }
        return result;
    ...
    public Set<E> uniqueSet() {
        if (uniqueSet == null) {
            uniqueSet = ImmutableSet.decorate(map.keySet());
        }
        return uniqueSet;
    }
