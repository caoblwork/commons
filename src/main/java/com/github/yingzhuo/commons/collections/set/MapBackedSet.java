 ...
 *
 */
public final class MapBackedSet<E, D> implements Set<E>, Serializable {
     ...
     */
    public static <E> Set<E> decorate(Map<E, Object> map) {
	...
	public static <E> Set<E> decorate(Map<E, Object> map, Object dummyValue) {
        if (map == null) {
     ...
     * @throws IllegalArgumentException if map is null
     */
    private MapBackedSet(Map<E, Object> map, D dummyValue) {
        super();
        this.map = map;
