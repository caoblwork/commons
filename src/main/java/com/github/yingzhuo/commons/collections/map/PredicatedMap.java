...
public class PredicatedMap<K, V>
    ...
    protected final Predicate<V> valuePredicate;
     ...
     */
    public static <K, V> Map<K, V> decorate(Map<K, V> map, Predicate<K> keyPredicate, Predicate<V> valuePredicate) {
     ...
     * @throws IllegalArgumentException if the map is null
     */
    protected PredicatedMap(Map<K, V> map, Predicate<K> keyPredicate, Predicate<V> valuePredicate) {
        super(map);
