...
import static com.github.yingzhuo.commons.functor.PredicateUtils.compose;
import static com.github.yingzhuo.commons.functor.PredicateUtils.equalTo;
import static com.github.yingzhuo.commons.functor.PredicateUtils.in;
import static com.github.yingzhuo.commons.functor.PredicateUtils.not;
...
import guava.annotations.GwtCompatible;
import guava.annotations.GwtIncompatible;
import guava.base.Equivalence;
import guava.base.Objects;
import guava.base.Preconditions;
import guava.base.Joiner.MapJoiner;
...
import com.github.yingzhuo.commons.collections.MapDifference.ValueDifference;
import com.github.yingzhuo.commons.functor.Function;
import com.github.yingzhuo.commons.functor.Predicate;
import com.github.yingzhuo.commons.functor.PredicateUtils;
...
public static <K extends Comparable, V> TreeMap<K, V> newTreeMap() {
  ...
  private static <K, V> Map<K, V> filterFiltered(AbstractFilteredMap<K, V> map,
    ...
    return new FilteredEntryMap<K, V>(map.unfiltered,
        PredicateUtils.<Entry<K, V>>and(map.predicate, entryPredicate));
  }
  ...
  private static final class FilteredMapValues<K, V> extends Maps.Values<K, V> {
    ...
    @Override public boolean remove(Object o) {
      return Iterables.removeFirstMatching(unfiltered.entrySet(),
          PredicateUtils.<Entry<K, V>>and(predicate, Maps.<V>valuePredicateOnEntries(equalTo(o))))
          != null;
    }

    private boolean removeIf(Predicate<? super V> valuePredicate) {
      return Iterables.removeIf(unfiltered.entrySet(), PredicateUtils.<Entry<K, V>>and(
  ...
  private static <K, V> SortedMap<K, V> filterFiltered(
    ...
    Predicate<Entry<K, V>> predicate
        = PredicateUtils.and(map.predicate, entryPredicate);
  ...
  private static <K, V> NavigableMap<K, V> filterFiltered(
      ...
      Predicate<? super Entry<K, V>> entryPredicate) {
    Predicate<Entry<K, V>> predicate
        = PredicateUtils.and(map.entryPredicate, entryPredicate);
      ...
      return new Maps.NavigableKeySet<K, V>(this) {
        ...
        public boolean removeAll(Collection<?> c) {
          return Iterators.removeIf(unfiltered.entrySet().iterator(),
              PredicateUtils.<Entry<K, V>>and(entryPredicate, Maps.<K>keyPredicateOnEntries(in(c))));
        }

        @Override
        public boolean retainAll(Collection<?> c) {
          return Iterators.removeIf(unfiltered.entrySet().iterator(), PredicateUtils.<Entry<K, V>>and(
  ...
  private static <K, V> BiMap<K, V> filterFiltered(
    ...
    Predicate<Entry<K, V>> predicate = PredicateUtils.and(map.predicate, entryPredicate);
