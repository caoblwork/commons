...
public class TransformedSortedBag<E>
	...
	public static <E> SortedBag<E> decorate(SortedBag<E> bag, Transformer<E> transformer) {
     ...
     * @throws IllegalArgumentException if bag or transformer is null
     */
    protected TransformedSortedBag(SortedBag<E> bag, Transformer<E> transformer) {
